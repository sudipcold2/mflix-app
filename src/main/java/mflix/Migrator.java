...
public class Migrator {
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@mflix.0yay8.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
        ...
        FindIterable<Document> documents = movies.find(queryFilter);
