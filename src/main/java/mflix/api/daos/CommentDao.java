...
public class CommentDao extends AbstractMFlixDao {
    ...
    public boolean updateComment(String commentId, String text, String email) {
        ...
        if(comment.getEmail().equals(email)){
            ...
            UpdateResult updateResult =
                    commentCollection.replaceOne(new Document("_id", new ObjectId(commentId)), comment);
    ...
    public boolean deleteComment(String commentId, String email) {
        ...
        if(comment != null && comment.getEmail().equals(email)){
            DeleteResult result = commentCollection.deleteOne(new Document("_id", new ObjectId(commentId)));
